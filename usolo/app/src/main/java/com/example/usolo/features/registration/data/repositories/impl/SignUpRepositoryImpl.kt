...
class SignUpRepositoryImpl(
    private val signUpService: SignUpApi = RetrofitConfig.directusRetrofit.create(SignUpApi::class.java)
): SignUpRepository {

    override suspend fun signUp(signUpRequest: SignUpRequestDTO): Result<UserWithProfileDTO> {
        return try {
            ...
            val userResponse = signUpService.createUser(
                user = userCreateDTO)
            ...
            val profileResponse = signUpService.createProfile(
